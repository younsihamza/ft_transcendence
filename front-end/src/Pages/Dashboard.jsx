...
export default function Dashboard() {
    return (
        <div className="text-white flex    flex-1">
                ...
                <div className="xsm:w-16 lg:w-74 xl:w-96  sm:w-28 md:w-32  xsm:items-end   py-8 flex xsm:flex-col  xsm:pr-2  xl:flex-row xl:justify-end sm:pr-4 xl:items-center  2xl:w-96">
                    <FriendsBar />
